...
| [`docs/KB_DESIGN.md`](ai-english-teacher/docs/KB_DESIGN.md) | **知识库方案**：模板 + 来源勾选 + 流程图。云写入待接 |
| [`docs/KB_SETUP.md`](ai-english-teacher/docs/KB_SETUP.md) | **家长开库清单**：Supabase 申请、SQL、GitHub Secrets、给下个 agent 的话 |
